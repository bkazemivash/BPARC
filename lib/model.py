...
class BrainSeg(nn.Module):
    ...
    def __init__(self, i_channel, h_channel):
        ...
        self.layer3 = nn.Dropout3d(p=.1)
        self.layer4 = ResEncBlocks(h_channel[1], h_channel[2])
        self.layer5 = ResEncBlocks(h_channel[2], h_channel[3])
        self.layer6 = ResDecBlocks(h_channel[3], h_channel[2])
        self.layer7 = nn.Dropout3d(p=.1)
        self.layer8 = ResDecBlocks(h_channel[2], h_channel[1])
    ...
    def forward(self, x):
        ...
        out = self.layer3(residual2)
        residual3 = self.layer4(out)
        out = self.layer5(residual3)
        out = self.layer6(out)
        out = self.layer7(out)
...
class BrainSegPP(nn.Module):
    ...
    def __init__(self, i_channel, h_channel):
        ...
        self.layer3 = nn.Dropout3d(p=.1)
        self.layer4 = ResEncBlocksPP(h_channel[1], h_channel[2])
        self.layer5 = ResEncBlocksPP(h_channel[2], h_channel[3])
        self.layer6 = ResDecBlocksPP(h_channel[3], h_channel[2])
        self.layer7 = nn.Dropout3d(p=.1)
        self.layer8 = ResDecBlocksPP(h_channel[2], h_channel[1])
